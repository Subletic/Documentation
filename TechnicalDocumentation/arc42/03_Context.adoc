...
==== Externe Videostreams (Fremdsystem)

Videostreams ohne Untertitlung können durch das Nutzen unseres Services, schnell und einfach mit Untertiteln versehen werden. Sie benötigen einfache/gebräuchliche Schnittstellen, sodass die Einbindung in unser System einfach möglich ist.
