...
| Angular-Pipeline crasht nach GitLab Umzug durchgängig | Entwickler können keinen Code Mergen | Verzögerung der Entwicklung | schnelle Reparatur der Pipeline | @lnoack | 27.05.2023 | 27.05.2023 | ??.??.2023
