...
| Implementieren der Echtzeit-Audiofunktionalitäten stellt sich als komplizierter als gedacht heraus, da kaum Kenntnisse im Team existieren | Problem | Produkt | hoch | 20.06.2023 | @bbeigang | Recherche zu möglichen Ansätzen, Bibliotheken, etc. und Verkleinerung des MVPs | @lnoack | offen
