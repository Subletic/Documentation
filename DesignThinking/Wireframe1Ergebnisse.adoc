...
image::./Prototypes/Wireframe_1/Pause_und_Zurück-Press.png[]

==== Alternative 2

image::./Prototypes/Wireframe_1/Pause_und_Zurück-Press_Alternative 2.png[]

==== Alternative 3

* anderer Schatten (nur teamrelevant)

image::./Prototypes/Wireframe_1/Pause_und_Zurück-Press_Alternative 1.png[]
...
image::./Prototypes/Wireframe_1/Scrollbar_fuer_Audio_+_Geschwindigkeit_+-.png[]
